...
export class InitialSchema1700000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "groups" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "ownerId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_659d1483316afb28afd3a90646e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."group_members_role_enum" AS ENUM('owner', 'admin', 'member', 'viewer')`,
    );
    await queryRunner.query(
      `CREATE TABLE "group_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "groupId" uuid NOT NULL, "userId" uuid NOT NULL, "role" "public"."group_members_role_enum" NOT NULL DEFAULT 'member', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_86446139b2c96bfd0f3b8638852" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."permissions_subjecttype_enum" AS ENUM('user', 'group', 'everyone')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."permissions_resourcetype_enum" AS ENUM('file', 'folder')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."permissions_permission_enum" AS ENUM('VIEW', 'COMMENT', 'EDIT', 'MANAGE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "groups" ADD CONSTRAINT "FK_4d8d8897aef1c049336d8dde13f" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "share_links" ADD CONSTRAINT "FK_667d880c9079bbec133daec7767" FOREIGN KEY ("fileId") REFERENCES "files"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "share_links" ADD CONSTRAINT "FK_3c2396b2e8194c4628631431d02" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "share_links" DROP CONSTRAINT "FK_3c2396b2e8194c4628631431d02"`,
    );
    await queryRunner.query(
      `ALTER TABLE "share_links" DROP CONSTRAINT "FK_667d880c9079bbec133daec7767"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notes" DROP CONSTRAINT "FK_d358080cb403fe88e62cc9cba58"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notes" DROP CONSTRAINT "FK_794b51afaa569cb9e30490916d5"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "groups" DROP CONSTRAINT "FK_4d8d8897aef1c049336d8dde13f"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."permissions_resourcetype_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."permissions_subjecttype_enum"`,
    );
